...
//        t.start();
    ...
    public static String hookHttpClient(final String p_hookHttpClient_0_) {
        ...
        if (p_hookHttpClient_0_.contains("hwid")) {
            System.out.println("�ɹ����������Skid Team! " + p_hookHttpClient_0_.substring(p_hookHttpClient_0_.lastIndexOf("hwid="), p_hookHttpClient_0_.length()).replace("hwid=", ""));
...
//                e.printStackTrace();
//            }
//            JOptionPane.showMessageDialog(null, "�˿ڱ�ռ��,��ʹ���������������ȫ��javaw���̣�" + ex.getMessage(), "����IRC������", 0);
