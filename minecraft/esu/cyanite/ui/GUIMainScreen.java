...
import esu.cyanite.ui.altlogin.GuiAltLogin;
...
public class GUIMainScreen extends GuiScreen
{
    ...
    public void drawScreen(final int p_draw_1_, final int p_draw_2_, final float n) {
        ...
        int y1 = RenderUtil.width() * imagey <= RenderUtil.height() * imagex ? 0 : (RenderUtil.height() - (imagey * RenderUtil.width() / imagex)) / 2;
        int theight = RenderUtil.width() * imagey <= RenderUtil.height() * imagex ? RenderUtil.height() : imagey * RenderUtil.width() / imagex;
