...
import esu.cyanite.ui.ClickGUI.option.UISlider;
import esu.cyanite.ui.ClickGUI.option.UIToggleButton;
...
public class ClickMenu {
    ...
    public void draw(int n, int n2) {
        ...
        if (this.settingMode && this.currentMod != null) {
            ...
            if (UIMenuMods.fuck) {
                RenderUtil.drawRoundRect1((int) (n3 / 2.0f - 100.0f), (int) (n4 / 2.0f - 130.0f), (int) (n3 / 2.0f + 100.0f), (int) (n4 / 2.0f + 130.0f), 4, new Color(39, 39, 39));
            } else {
                RenderUtil.drawRoundedRect((int) (n3 / 2.0f - 100.0f), (int) (n4 / 2.0f - 130.0f), (int) (n3 / 2.0f + 100.0f), (int) (n4 / 2.0f + 130.0f), (int) 5.0f, Colors.WHITE.c);
            }
            ...
            for (Value values2 : this.modBooleanValue) {
                ...
                if (UIMenuMods.fuck) {
                    Client.instance.fontMgr.tahoma20.drawString(values2.getValueName().split("_")[1], n3 / 2.0f - 94.0f, currentStartY - 2.0f, Colors.WHITE.c);
                } else {
            ...
            for (Value currentSelectingMode : this.modModeValue) {
                if (UIMenuMods.fuck) {
                    Client.instance.fontMgr.tahoma20.drawString(currentSelectingMode.getModeTitle(), n3 / 2.0f - 94.0f, currentStartY - 2.0f, Colors.WHITE.c);
                } else {
                ...
                try {
                    if (UIMenuMods.fuck) {
                        Client.instance.fontMgr.tahoma16.drawString(currentSelectingMode.getModeAt(currentSelectingMode.getCurrentMode()), n3 / 2.0f + 28.0f, currentStartY, new Color(173,173,173).getRGB());
                    } else {
            ...
            if (this.isSelectingMode && this.currentSelectingMode != null) {
                ...
                if (UIMenuMods.fuck) {
                    RenderUtil.drawRoundRect1((int) (n3 / 2.0f + 102.0f), (int) currentStartY2, (int) (n3 / 2.0f + 182.0f), (int) (currentStartY2 + 15 * currentSelectingMode2.mode.size()), (int) 4.0f, new Color(39, 39, 39));
                } else {
                ...
                while (i < currentSelectingMode2.mode.size()) {
                    if (UIMenuMods.fuck) {
                        Client.instance.fontMgr.tahoma15.drawString((String) currentSelectingMode2.mode.get(i), n3 / 2.0f + 106.0f, currentStartY2 + 3.0f, Colors.WHITE.c);
                    } else {
    ...
    public void mouseClick(int n, int n2) {
        Iterator<Button> iterator = booleanValueMap.values().iterator();
        while (iterator.hasNext()) {
