...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    public static float ft = 114514, f1t = 114514, f8t = 114514;
        ...
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[]{entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)})) {
            ...
            try {
                ...
                if (entity == Minecraft.getMinecraft().thePlayer) {
                    if (ft == 114514) {
                        ft = entity.renderYawOffset;
                    }
                    if (f1t == 114514) {
                        f1t = entity.rotationYawHead;
                    }
                    if (f8t == 114514) {
                        f8t = entity.rotationPitch;
                    }
                }
                ...
                if(ModManager.getModByName("RotationAnimation").isEnabled() && (ModManager.getModByName("Aura").isEnabled() || ModManager.getModByName("Scaffold").isEnabled())){
                    if (entity == Minecraft.thePlayer) {
                        ...
                        if(Client.yaw != 114514 && Client.pitch != 114514){
                            f = this.interpolateRotation(ft, Client.yaw, partialTicks);
                            f1 = this.interpolateRotation(f1t, Client.yaw, partialTicks);
                            f8 = f8t + (Client.pitch - f8t) * partialTicks;
                        }else{
                            f = this.interpolateRotation(ft, entity.renderYawOffset, partialTicks);
                            f1 = this.interpolateRotation(f1t, entity.rotationYawHead, partialTicks);
                            f8 = f8t + (entity.rotationPitch - f8t) * partialTicks;
                        }
                        partialTicks *= 4;
                    }
                }
